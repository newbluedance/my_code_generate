...
public class JdbcTypeNameTranslator {
     ...
     * representation of the jdbcTypeName.
     * 
     * @param jdbcType
     *            a value from java.sql.Types
     * @return the iBATIS String representation of a JDBC jdbcTypeName
     */
    ...
    /**
     * Translates from the string representation of the jdbcTypeName to the
     * java.sql.Types value.
     * 
     * @param jdbcTypeName
     *            the iBATIS String representation of a JDBC jdbcTypeName
