...
public class FullyQualifiedJavaType implements
    ...
    /** The short jdbcName without any generic arguments. */
    private String baseShortName;

    /** The fully qualified jdbcName without any generic arguments. */
    private String baseQualifiedName;

    /** The explicitly imported. */
    private boolean explicitlyImported;
    
    /** The package jdbcName. */
    ...
    /**
     * Use this constructor to construct a generic jdbcTypeName with the specified jdbcTypeName parameters.
     *
     * @param fullTypeSpecification
     *            the full jdbcTypeName specification
     */
    ...
    /**
     * This method returns the fully qualified jdbcName - including any generic jdbcTypeName parameters.
     *
    ...
    /**
     * Returns a list of Strings that are the fully qualified names of this jdbcTypeName, and any generic jdbcTypeName argument
     * associated with this jdbcTypeName.
     *
    ...
    /**
     * Gets the short jdbcName.
     *
     * @return Returns the shortName - including any jdbcTypeName arguments.
     */
    ...
    /**
     * Gets the primitive jdbcTypeName wrapper.
     *
    ...
    public static final FullyQualifiedJavaType getNewMapInstance() {
        // always return a new instance because the jdbcTypeName may be parameterized
    ...
    /**
     * Adds the jdbcTypeName argument.
     *
     * @param type
     *            the jdbcTypeName
     */
    ...
    private void parse(String fullTypeSpecification) {
        ...
        if (spec.startsWith("?")) { //$NON-NLS-1$
            ...
            // array jdbcTypeName like byte], but it will detect byte[] and byte[   ]
     ...
     *            the jdbcTypeName specification
     */
    ...
    /**
     * Returns the package jdbcName of a fully qualified jdbcTypeName.
     * 
     * This method calculates the package as the part of the fully qualified jdbcName up to, but not including, the last
