...
import static com.lcfsxg.generater.common.OutputUtilities.*;
...
public class Interface extends JavaElement implements CompilationUnit {
    ...
    public String getFormattedContent() {
        ...
        Iterator<String> fieldIter = getFieldLines().iterator();
        while (fieldIter.hasNext()) {
            newLine(sb);
            String filedLine = fieldIter.next();
            sb.append(filedLine);
     ...
     *            the fieldLines
     */
    public void addFieldLines(String fieldLine) {
